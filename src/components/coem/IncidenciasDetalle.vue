        ...
        <v-row class="d-flex justify-center">
            ...
            <v-col cols="12" md="8" lg="8" xl="6">
                ...
                <v-card>
                    ...
                    >
                        <v-tab :value="1">Incidencias Eventos</v-tab>
                        <v-tab :value="2" v-if="tipo == 'C'">
                            <v-badge :content="incidenceData.pendientes" v-if="incidenceData.pendientes > 0"  color="red-darken-3">
                                <div class="pr-3">Incidencias Protocolos</div>
                            </v-badge>
                            <div v-else>
                                Incidencias Protocolos
                            </div>
                        </v-tab>
                    </v-tabs>
                        ...
                        <v-tabs-window-item :value="1">
                            ...
                            <v-card>
                                ...
                                <div class="table-wrapper">
                                    ...
                                    <v-data-table 
                                        :items="incidenceData.incidencias"
                                        :headers="incidenceData.incidenciasHeader"
                                        :search="search"
                                    ...
                                    >
                                        ...
                                        <template v-slot:item.acciones="{item}">
                                            <v-btn 
                                                size="small" 
                                                color="primary"
                                                @click="incidenceData.checkDetail(item)"
                                            >
                                                Ver Detalles
                                            </v-btn>
                                        </template>
                                        ...
                                        <template v-slot:top>
                                            ...
                                            <v-toolbar>
                                                ...
                                                <v-btn
                                                    variant="elevated"
                                                    color="teal-darken-1"
                                                    @click="incidenceData.checkStats()"
                                                >
                                                    Ver estadísticas
                                                </v-btn>
